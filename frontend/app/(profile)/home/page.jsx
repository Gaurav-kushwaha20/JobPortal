            ...
            {vacancies &&
                ...
                >
                    {vacancies.map((job, index) => (
                        <Link key={index} href={`/vacancy/${job._id}`}>
                            <div
                                className="bg-white shadow-lg rounded-lg p-6 border border-gray-200 hover:shadow-2xl transition-all duration-300 ease-in-out"
                            >
                                {/* Image Section */}
                                <div className="flex items-center gap-6">
                                    <img
                                        src={`${backendUrl}/public/vacancy/${job.photo}`} // Replace this with the image URL from your job data
                                        alt={job.title}
