...
import { changePassword, verifyTokenForResetPassword } from '@/app/api/UserAPI'
...
const page = () => {
    ...
    useEffect(() => {
        ...
        // verify the token
        verifyTokenForResetPassword(token, backend_url)
            .then(data => {
                if (data?.error) {
                    Swal.fire({
                        position: 'center',
    ...
    const handleSubmit = e => {
        ...
        changePassword({ password: formValue.password }, token, backend_url)
            .then(data => {
                if (data?.error) {
                    Swal.fire({
                        position: 'center',
